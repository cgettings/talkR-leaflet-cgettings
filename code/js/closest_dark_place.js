...
for (let i = 0; i < data.x.length; i++) {
    ...
    grid_coords[i] = new L.LatLng(data.y[i], data.x[i], data.brightness_values[i]);
...
const dark_point_function = function(e) {
    ...
    if (typeof dark_points !== "undefined") {
        ...
        for (let k = 0; k < dark_points.length; k++) {
...
let data_fl = document.getElementById("Sky Brightness-1-attachment").href;
