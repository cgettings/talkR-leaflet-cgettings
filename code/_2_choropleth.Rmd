...
packages_we_use <- c("dplyr", "tidyr", "leaflet", "jsonlite", "geojsonio", "sf", "viridisLite", "here", "htmlwidgets", "conflicted")
...
Let's make a choropleth using data from the [Environment and Health Data Portal](https://a816-dohbesp.nyc.gov/IndicatorPublic/).
...
# first generate a color palette function using viridis
